    ...
    protected function output() {
        if (!$this->get('router_login_state')) {
            $css = '<style type="text/css">@font-face { font-family: "Manrope";'.
                ...
                'height:100%;margin:0px;background-image: linear-gradient(45deg,#96BAFF, #7C83FD);'.
...
class Hm_Output_page_js extends Hm_Output_Module {
    ...
    protected function output() {
        if (DEBUG_MODE) {
            ...
            $js_lib = '<script type="text/javascript" src="third_party/jquery.min.js"></script>';
...
class Hm_Output_main_menu_start extends Hm_Output_Module {
     ...
     */
    protected function output() {
        $res = '<div class="src_name main_menu open" data-source=".main">'.$this->trans('Main');
        if (DEBUG_MODE) {
            $res .= ' <span title="'.
